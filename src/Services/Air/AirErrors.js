...
Object.assign(AirRuntimeError, createErrorsList({
  ...
  ParseTicketPNRError: ['Failed to parse PNR from ticket information request response', errorCodes.Validation],
  GetBookingByTicketNumberError: 'Unexpectedly failed to obtain PNR from ticket information',
